#!/bin/bash
# Mini version for testing on interactive node (4x A100 80GB) - NoArxiv - WITH LIGER
# Usage: ./run_noarxiv_training_mini_liger.sh
...
echo "==========================================="
echo "NoArxiv Training - MINI (With Liger)"
...
EXPORT_PATH="/scratch/gpfs/ZHUANGL/sk7524/SkyRLSearchEnvs/skyrl-train/exports/noarxiv_mini_liger/${JOB_ID}"
...
python -m skyrl_train.entrypoints.main_base \
  ...
  trainer.project_name="noarxiv_mini_liger" \
  trainer.run_name="noarxiv_mini_liger_${JOB_ID}" \
