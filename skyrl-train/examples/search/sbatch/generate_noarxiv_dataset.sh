#!/bin/bash
# Generate parquet dataset from ShareGPT JSON for NoArxiv paper acceptance prediction (no search)
#
...
OUTPUT_DIR="${2:-/scratch/gpfs/ZHUANGL/sk7524/SkyRL/skyrl-train/data/noarxiv_iclr}"
TRAIN_RATIO="${3:-0.9}"
...
echo "==========================================="
echo "NoArxiv Dataset Generator (No Search)"
echo "==========================================="
...
python "$SCRIPT_DIR/searchr1_noarxiv_dataset.py" \
