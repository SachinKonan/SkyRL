#!/bin/bash
#SBATCH --job-name=searchr1_branched_grpo_src2_nowarmup
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
echo "Backend: vLLM"
echo "GPUs: 4"
echo "Branching: src_trajectories=2, n_samples_per_prompt=10"
...
python -m skyrl_train.entrypoints.main_base \
  ...
  trainer.run_name="searchr1_branched_grpo_src2_gr10_nowarmup_${SLURM_JOB_ID}" \
